...
- 해당 코드는 웹 브라우저에서 실행되며, 외부 리소스를 전혀 사용하지 않고, 언어 특성상 cmd 명령어(파일 시스템, 운영체제에 접근)를 실행할 수 없으므로 **악성 코드가 없어 안전하며** 안심하고 다운로드 받아도 됩니다. 개발자는 팬심으로 해당 코드 사이트로 연결되는 큐알코드를 2024년 12월 4일 20시 52분 김예원 배우(AKA Pristin 예하나 맞습니다)님에게 전달드렸습니다.
